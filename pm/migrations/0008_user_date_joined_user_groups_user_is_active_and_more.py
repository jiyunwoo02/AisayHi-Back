...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='user',
            name='password',
            field=models.CharField(default='pbkdf2_sha256$720000$l6lmSwly3hBGKH188Wx2UP$KbNS6aR7zFT14OMmXv+xr4nF+i5sXNdEHVQIe5IAryg=', max_length=128),
        ),
        migrations.AddField(
            model_name='user',
